...
void Gmizavci::insert_animal() {
    ...
    while (c == "y") {
        ...
        cout << "Porodica           :";
        cin >> porodica;
        cout << "Koza je prekriveno :";
        cin >> koza;
        cout << "Otrovne da ili ne  :";
        cin >> otrovne;
        cout << "___________________________________\n";
        ...
        write << s.getId() << " " << s.getIme() << " " << s.getNaucnoIme() << " " << s.getTip() << " "
              << s.getPorodica() << " " << s.getKozaPrekrivena() << " " << s.getOtrovne() << endl;
...
void Gmizavci::update_animal() {
    ...
    stud << s.getId() << " " << s.getIme() << " " << s.getNaucnoIme() << " " << s.getTip() << " " << s.getPorodica()
         << " " << s.getKozaPrekrivena() << " " << s.getOtrovne() << endl;
